...
public:
	virtual void f(void)  { printf("derived::f1()\n"); }
...
int main(int argc, const char *argv[])
{
	...
	((pf)*(*((int **)&d + 0) + 0))(); 	// derived:f()
	((pf)*(*((int **)&d + 0) + 1))();	// base1::g()
	((pf)*(*((int **)&d + 0) + 2))(); 	// base1::h()
	((pf)*(*((int **)&d + 0) + 3))(); 	// derived::g()
	((pf)*(*((int **)&d + 0) + 4))(); 	// derived::h()
//	((pf)*(*((int **)&d + 0) + 5))();

	printf("\n");

	((pf)*(*((int **)&d + 1) + 0))(); 	// derived:f()
	((pf)*(*((int **)&d + 1) + 1))(); 	// base2::g()
	((pf)*(*((int **)&d + 1) + 2))(); 	// base3::h()

	printf("\n");

	((pf)*(*((int **)&d + 2) + 0))(); 	// derived:f()
	((pf)*(*((int **)&d + 2) + 1))(); 	// base3::g()
	((pf)*(*((int **)&d + 2) + 2))(); 	// base3::h()
