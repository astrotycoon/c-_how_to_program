...
# 34 "/usr/include/c++/4.4/typeinfo" 3
...
# 33 "/usr/include/c++/4.4/i686-linux-gnu/./bits/cxxabi_tweaks.h" 3
namespace __cxxabiv1
{
  extern "C"
  {
# 45 "/usr/include/c++/4.4/i686-linux-gnu/./bits/cxxabi_tweaks.h" 3
...
int main(int argc, const char *argv[])
{
 ...
 printf("%s\n", __cxxabiv1::__cxa_demangle(typeid((*(type_info *)*(*(int **)&d - 1)).name()).name(), 0, 0, 0);
